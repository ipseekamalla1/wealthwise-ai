...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[220px] bg-[#1e293b] border-r border-[#1e3a5f] flex flex-col z-40">
      ...
      <div className="px-3 py-4 border-t border-[#1e3a5f] space-y-0.5">
        <Link
          href="/settings"
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-400 hover:text-slate-200 hover:bg-white/5 transition-colors"
        >
